...
public class IncreaseProcessInstancesHandler {
    public static void handle(Scanner scanner, SGServiceGrpc.SGServiceBlockingStub sgBlockingStub) {
        System.out.println("Number of processing instances to add: ");
        try {
            ...
            ScaleResponse response = sgBlockingStub.increaseProcessingInstances(request);
            ...
            System.out.println("Error increasing processing instances: " + e.getMessage());
        }
    }
}
