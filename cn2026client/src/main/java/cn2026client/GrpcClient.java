package cn2026client;

import cn2026client.handlers.*;
...
public class GrpcClient {
    ...
    private static List<String> fetchServers() throws Exception {
    ...
    private static String chooseServer(Scanner scanner,
                                       List<String> servers) {
        System.out.println();
        ...
        } while (option < 1 || option > servers.size());

        return servers.get(option - 1);
    }
